...
> 归档于 2026-09-16（该轮修复与验收已关闭）。后续活动入口见
> [在线版本与 LLM 增强计划](../plans/2026-09-15-online-llm.md)，遗留缺陷见
> [产品可用性记录](2026-09-15-product-readiness.md) 与
> [bindingdb-io 移植记录](../plans/2026-09-15-bindingdb-io-port.md)。
